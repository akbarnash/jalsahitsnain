...
public class VideoPostAdapter2 extends RecyclerView.Adapter<VideoPostAdapter2.YoutubePostHolder> {
    ...
    public VideoPostAdapter2(Context mContext, ArrayList<YoutubeDataModel> dataSet, OnItemClickListener listener) {
    ...
    public YoutubePostHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtube_post_layout2,parent,false);
    ...
    public void setFilter(ArrayList<YoutubeDataModel> filterList){
